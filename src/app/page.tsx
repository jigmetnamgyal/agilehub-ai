...
export default function Home() {
  return (
    <main className="flex h-auto flex-col items-center">
        <NavBar />
        <div className="h-[400px] w-full flex flex-col justify-center items-center text-center gap-10">
        ...
        <div className="mockup-browser border border-base-300 w-[80%] h-[600px] mt-14">
          <span className="indicator-item badge bg-yellow-300 p-4 text-black absolute right-0 top-3 -rotate-12">Work 10x faster</span> 
      ...
      <div className="hero h-auto relative p-52">
        <div className="hero-content text-center">
          <div className="w-[70%]">
            <h1 className="text-5xl leading-[65px] font-bold">Jaggle your coworker, supercharged by AI.</h1>
