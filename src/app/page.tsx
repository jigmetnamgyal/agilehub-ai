  ...
  return (
    <main className="flex h-[800px] flex-col items-center">
        ...
        <div className="h-[300px] w-full flex flex-col justify-center items-center text-center gap-12">
          <p className="text-4xl">AI: The <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-300 via-red-300 to-yellow-300">Ultimate Empowerment</span> Partner for Your Team.</p>
